...
namespace CryptoGate.Model
{
    ...
    public partial class ListPlans200Response : IValidatableObject
    {
        ...
        public ListPlans200Response(Object success = default(Object), ListPlans200ResponseData data = default(ListPlans200ResponseData))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new ArgumentNullException("success is a required property for ListPlans200Response and cannot be null");
            }
        ...
        public ListPlans200ResponseData Data { get; set; }
