...
namespace CryptoGate.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listBalances_200_response_data")]
    public partial class ListBalances200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBalances200ResponseData" /> class.
        /// </summary>
        /// <param name="balances">balances.</param>
        public ListBalances200ResponseData(List<Balance> balances = default(List<Balance>))
        {
