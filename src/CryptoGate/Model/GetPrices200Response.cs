...
namespace CryptoGate.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPrices_200_response")]
    public partial class GetPrices200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPrices200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPrices200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPrices200Response" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="data">data (required).</param>
        public GetPrices200Response(Object success = default(Object), GetPrices200ResponseData data = default(GetPrices200ResponseData))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new ArgumentNullException("success is a required property for GetPrices200Response and cannot be null");
            }
            this.Success = success;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetPrices200Response and cannot be null");
            }
            this.Data = data;
        }
        ...
        public GetPrices200ResponseData Data { get; set; }
