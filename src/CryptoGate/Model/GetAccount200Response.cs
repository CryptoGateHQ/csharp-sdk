...
namespace CryptoGate.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAccount_200_response")]
    public partial class GetAccount200Response : IValidatableObject
    {
        ...
        protected GetAccount200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAccount200Response" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="data">data (required).</param>
        public GetAccount200Response(Object success = default(Object), Account data = default(Account))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new ArgumentNullException("success is a required property for GetAccount200Response and cannot be null");
            }
            this.Success = success;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetAccount200Response and cannot be null");
            }
            this.Data = data;
        }
