...
namespace CryptoGate.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listPlans_200_response_data")]
    public partial class ListPlans200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPlans200ResponseData" /> class.
        /// </summary>
        /// <param name="plans">plans.</param>
        /// <param name="billingCycles">billingCycles.</param>
        public ListPlans200ResponseData(List<Plan> plans = default(List<Plan>), List<string> billingCycles = default(List<string>))
        {
            this.Plans = plans;
