...
namespace CryptoGate.Model
{
    ...
    public partial class Balance : IValidatableObject
    {
        ...
        /// <param name="pendingBalance">pendingBalance.</param>
        /// <param name="updatedAt">updatedAt.</param>
        public Balance(string currency = default(string), decimal availableBalance = default(decimal), decimal pendingBalance = default(decimal), DateTime updatedAt = default(DateTime))
        {
        ...
        /// </summary>
        [DataMember(Name = "pending_balance", EmitDefaultValue = false)]
