...
namespace CryptoGate.Model
{
    ...
    /// TransactionEnvelope
    /// </summary>
    [DataContract(Name = "TransactionEnvelope")]
    public partial class TransactionEnvelope : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEnvelope" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionEnvelope() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionEnvelope" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="data">data (required).</param>
        public TransactionEnvelope(Object success = default(Object), Transaction data = default(Transaction))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new ArgumentNullException("success is a required property for TransactionEnvelope and cannot be null");
            }
            this.Success = success;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for TransactionEnvelope and cannot be null");
            }
            this.Data = data;
        }
